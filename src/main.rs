...
fn main() {
    ...
    println!("Day 20 Part 1: {}", day20::solve_part1(&day20parsed));
    println!("Day 20 Part 2: {}", day20::solve_part2(&day20parsed));

    let day21in = include_bytes!("../input/21/input.txt");
    let day21parsed = day21::parse_input(day21in).expect("Failed to parse input file for day 21");
    println!("Day 21 Part 1: {}", day21::solve_part1(&day21parsed));
    println!("Day 21 Part 2: {}", day21::solve_part2(&day21parsed));

    let day22in = include_bytes!("../input/22/input.txt");
    let day22parsed = day22::parse_input(day22in).expect("Failed to parse input file for day 22");
    println!("Day 22 Part 1: {}", day22::solve_part1(&day22parsed));
    println!("Day 22 Part 2: {}", day22::solve_part2(&day22parsed));

    let day23in = include_bytes!("../input/23/input.txt");
    let day23parsed = day23::parse_input(day23in).expect("Failed to parse input file for day 23");
    println!("Day 23 Part 1: {}", day23::solve_part1(&day23parsed));
    println!("Day 23 Part 2: {}", day23::solve_part2(&day23parsed));

    let day24in = include_bytes!("../input/24/input.txt");
    let day24parsed = day24::parse_input(day24in).expect("Failed to parse input file for day 24");
    println!("Day 24 Part 1: {}", day24::solve_part1(&day24parsed));
    println!("Day 24 Part 2: {}", day24::solve_part2(&day24parsed));

    let day25in = include_bytes!("../input/25/input.txt");
    let day25parsed = day25::parse_input(day25in).expect("Failed to parse input file for day 25");
    println!("Day 25 Part 1: {}", day25::solve_part1(&day25parsed));
}
