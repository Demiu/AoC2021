...
fn main() {
    ...
    let day4in = include_bytes!("../input/4/bigboy.txt");
    ...
    let day5in = include_bytes!("../input/5/bigboy-50000-10000000.txt");
    let day5parsed = day5::parse_input(day5in).expect("Failed to parse input file for day 4");
